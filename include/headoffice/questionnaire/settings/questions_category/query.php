<?php
	...
	if(isset($_POST['submit_add'])) {
		...
		if($dblms->getRows(QUESCATEGORY, $condition)) {
			...
			$sqllms		=	$dblms->insert(QUESCATEGORY, $values);
			if($sqllms) { 
	...
	if(isset($_POST['submit_edit'])) {
		...
		if($dblms->getRows(QUESCATEGORY, $condition)) {
			...
			$sqllms = $dblms->Update(QUESCATEGORY , $values , "WHERE cat_id= '".cleanvars($_POST['cat_id'])."'");
	...
	if(isset($_GET['deleteid'])) {
		...
		$sqlDel = $dblms->Update(QUESCATEGORY , $values , "WHERE cat_id='".cleanvars($latestID)."'");
		if($sqlDel) { 
