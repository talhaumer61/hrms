...
if (!empty($_GET['search_word'])) {
    ...
    $search_query   .= " AND (scale_name LIKE '%".$search_word."%' OR scale_total LIKE '%".$search_word."%')";
    $filters        .= '&search_word='.$search_word.'';
}
$condition = array(
                     'select'       =>  'scale_id,scale_status,scale_name,scale_total'
                    ,'where'        =>  array(
                                                'is_deleted'  => 0
                                            )
...
<div class="card">
    ...
    <div class="card-body">        
        ...
        $regions     = $dblms->getRows(SCALES, $condition);
        if ($regions) {
            echo'
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="cursor: pointer;">
                                            ...
                                            <li><a class="dropdown-item" onclick="confirm_modal(\''.moduleName().'.php?deleteid='.$row['scale_id'].'\');"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>';
