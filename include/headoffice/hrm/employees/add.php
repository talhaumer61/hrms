                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="nav-border-justified-0" role="tabpanel">
                        ...
                        <div class="hstack gap-2 justify-content-end pt-3">
                            <a href="?" class="btn btn-danger btn-sm"><i class="ri-close-circle-line align-bottom me-1"></i>Cancel</a>
                            <button class="btn btn-primary btn-sm" name="submit_add_employee"><i class="ri-add-circle-line align-bottom me-1"></i>Add Employee</button>
                        </div>
                    </div>
