        ...
        <div class="modal-body">
            <div class="row">
                <div class="col mb-2">
                    ...
                    <input type="text" name="btype_name" class="form-control" required="" />
                </div>
                <div class="col mb-2">
                    <label class="form-label">Code<span class="text-danger">*</span></label>
                    <input type="text" name="btype_code" class="form-control" required="" />
                </div>
                <div class="col mb-2">
            ...
            <div class="row">
                <div class="col mb-2">
                    ...
                    <textarea type="text" name="btype_detail" id="ckeditor" class="form-control"></textarea>
                </div>
            </div>
        </div>
