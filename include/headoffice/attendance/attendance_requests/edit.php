<?php 
$condition = array(
    'select'       =>  'id,status, id_emply, id_dept, id_designation, id_location, id_branch, id_shift, dated, checkintime, timeend, checkouttime, approved_duration, punchtype, punchtime,detail'
    ,'where'        =>  array(
                               'is_deleted'  => 0,
...
$value = $dblms->getRows(ATTENDANCEREQUESTS, $condition);
$condition5 = array(
        ...
        <form autocomplete="off" class="form-validate"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="col-4 mb-2">
                    ...
                    <input class="form-control" type="time" name="checkintime" value="'.$value['checkintime'].'" ="">
                </div>
            </div>
            <div class="row">
                <div class="col-4 mb-2">
                ...
                <div class="col-4 mb-2">
                    ...
                    <input class="form-control" type="time" name="timeend" value="'.$value['timeend'].'" >
                </div>
                <div class="col-4 mb-2">
                    <label class="form-label">Check-Out Time </label>
                    <input class="form-control" type="time"  name="checkouttime" value="'.$value['checkouttime'].'"data-provider="timepickr" data-min-time="Min.Time" data-max-time="Max.Time">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-6 mb-2">
                    ...
                    <select class="form-control" data-choices name="punchtype" value="'.$value['punchtype'].'" >
                        <option value=""> Choose one</option>';
                        foreach(get_punchtype() as $key => $status) {
                            if($value['punchtype'] == $key){
                               echo'<option value="'.$key.'" selected>'.$status.'</option>';
                            } else {
                               echo'<option value="'.$key.'">'.$status.'</option>';
                            }
                ...
                <div class="col-6 mb-2">
                    ...
                    <input class="form-control" type="time" name="punchtime" value="'.$value['punchtime'].'" >
                </div>
            </div>  
        </div>
