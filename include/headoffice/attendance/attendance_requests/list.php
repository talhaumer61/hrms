...
$condition = array(
    'select'       =>  'a.id, a.status, a.id_emply, a.id_dept, a.id_designation, a.id_location, a.id_branch, a.id_shift, a.dated, a.checkintime, a.timeend, a.checkouttime, a.approved_duration, a.punchtype, a.punchtime, l.location_name, b.branch_name',
...
$count     = $dblms->getRows(ATTENDANCEREQUESTS.' a', $condition);
echo'
<div class="card">
    ...
    <div class="card-body">        
        ...
        $relation = $dblms->getRows(ATTENDANCEREQUESTS.' a', $condition);
        if ($relation) {
            echo'
                    ...
                    <tbody>';
                        ...
                        foreach ($relation as $row) {
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td>'.get_punchtype($row['punchtype']).'</td>
                                <td>'.$row['punchtime'].'</td>
