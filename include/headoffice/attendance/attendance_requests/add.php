        ...
        <div class="card-body mb-2">
            ...
            <div class="row">
                ...
                <div class="col-4 mb-2">
                    ...
                    <input class="form-control" type="time" name="checkintime" required="required">
                </div>
            </div>
            <div class="row">
                <div class="col-4 mb-2">
                ...
                <div class="col-4 mb-2">
                    ...
                    <input class="form-control" type="time" name="timeend" required="required">
                </div>
                <div class="col-4 mb-2">
                    <label class="form-label">Check-Out Time <span class="text-danger">*</span></label>
                    <input class="form-control" type="time" required="required" name="checkouttime" data-provider="timepickr" data-min-time="Min.Time" data-max-time="Max.Time">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-6 mb-2">
                    ...
                    <select class="form-control" data-choices name="punchtype" required="required">
                        <option value=""> Choose one</option>';
