	...
	<div class="card">
		<div class="card-header">
			<div class="d-flex align-items-center">
				...
				<button class="btn btn-primary btn-sm" onclick="showAjaxModalZoom(\'include/modals/applicants/bank_account/add.php?id='.cleanvars($_GET['id']).'\');"><i class="ri-add-circle-line align-bottom me-1"></i>Product</butt>
			</div>
		</div>';       
