				...
				<div class="card-body">
					...
					<div class="timeline">';
						...
						foreach($arr as $key => $val):
							echo '
							<div class="timeline-item '.(($key%2==1)?'right':'left').'">
								<i class="icon ri-stack-line"></i>
								<div class="date fs-13">15 Dec 2021 </div>
								<div class="content">
									<div class="d-flex">
										<div class="flex-grow-1 ms-3">
											<h5 class="fs-14">@Erica245 <span class="badge bg-soft-success text-success fs-10 align-middle ms-1">Completed</span> <small class="text-muted fs-13 fw-normal">- 10 min Ago</small></h5>
