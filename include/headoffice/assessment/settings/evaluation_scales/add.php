        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col mb-2">
                    ...
                    <input type="text" name="scale_shortname" class="form-control" required="" />
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Value<span class="text-danger">*</span></label>
                    <input type="text" name="scale_value" class="form-control" required="" />
                </div>
                <div class="col mb-2">
            ...
            <div class="row">
                <div class="col mb-2">
                    ...
                    <textarea type="text" name="scale_detail" id="ckeditor" class="form-control"></textarea>
                </div>
            </div>
        </div>
