...
$condition = array(
                     'select'       =>  'currency_id,currency_status,currency_name,currency_code,currency_symbol,currency_fractionalunits,currency_position'
                    ,'where'        =>  array(
                                                'is_deleted'  => 0
                                            )
                    ,'search_by'    =>  'AND (currency_name LIKE "%'.$search_word.'%")'
                    ,'order_by'     =>  'currency_id ASC'
                    ,'return_type'  =>  'count'
);
$count     = $dblms->getRows(CURRENCIES, $condition);
echo'
<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1"><i class="ri-file-paper-2-fill align-bottom me-1"></i>Currencies List</h5>
            <div class="flex-shrink-0">
                <a class="btn btn-primary btn-sm" onclick="showAjaxModalZoom(\'include/modals/currencies/add.php\');"><i class="ri-add-circle-line align-bottom me-1"></i>Currencies</a>
            </div>
        </div>
    </div>
    <div class="card-body">        
        <div class="row justify-content-end">
            <div class="col-3">
                <form action="currencies.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="get" autocomplete="off" accept-charset="utf-8">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Currency Name" name="search_word" value="'.$search_word.'">
        ...
        $condition['order_by'] = "currency_id ASC LIMIT " . ($page - 1) * $Limit . ",$Limit";
                ...
                <table class="table table-nowrap mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th width="70" class="text-center">Fraction Unit</th>
