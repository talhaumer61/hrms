...
$condition = array(
                     'select'       =>  'region_id, region_name, region_code, region_alpha, region_status'
                    ,'where'        =>  array(
                                                 'is_deleted'     => 0
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input class="form-control" value="'.$row['region_code'].'" name="region_code" type="number" placeholder="Enter Code (Digit)" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-2">
                        <label class="form-label">Code (Alpha) <span class="text-danger">*</span></label>
                        <input class="form-control" value="'.$row['region_alpha'].'" name="region_alpha" type="text" placeholder="Enter Code (Alpha)" required>
                    </div>
                </div>
                <div class="row"> 
                    <div class="col mb-2">
