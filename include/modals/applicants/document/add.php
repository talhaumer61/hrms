...
<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header bg-primary p-3">
            <h5 class="modal-title" id="exampleModalLabel"><i class="ri-add-circle-line align-bottom me-1"></i>Add Document</h5>
        ...
        <form action="applicants.php?id='.cleanvars($_GET['id']).'" autocomplete="off" class="form-validate"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col mb-2">
                        ...
                        <input type="text" name="document_date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" required="" />
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <div class="hstack gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" name="submit_add_document"><i class="ri-add-circle-line align-bottom me-1"></i>Add Document</button>
                </div>
            </div>
        </form>
    </div>
