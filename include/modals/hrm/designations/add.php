            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col mb-2">
                        ...
                        <input type="text" name="designation_shortname" class="form-control" required="" />
                    </div>
                    <div class="col mb-2">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <textarea type="text" name="designation_description" id="ckeditor" class="form-control"></textarea>
                    </div>
                </div>
            </div>
