...
<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header bg-primary p-3">
            <h5 class="modal-title" id="exampleModalLabel"><i class="ri-add-circle-line align-bottom me-1"></i>Add Country</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input type="text" name="country_isodigit" id="country_isodigit" class="form-control" required="" >
                    </div>
                    <div class="col mb-2">
