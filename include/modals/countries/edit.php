...
$condition = array(
                     'select'       =>  'country_id,country_status,country_name,country_isodigit,country_iso3digit,country_code,country_timezone,country_latitude,country_longitude,id_currency,id_region'
                    ,'where'        =>  array(
                                                 'is_deleted'     => 0
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col mb-2">
                        ...
                        <input type="text" name="country_code" value="'.$row['country_code'].'" id="country_code" class="form-control" required="" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input type="text" name="country_isodigit" value="'.$row['country_isodigit'].'" id="country_isodigit" class="form-control" required="" >
                    </div>
                    <div class="col mb-2">
                ...
                <div class="row"> 
                    <div class="col mb-2">
                        ...
                        <select class="form-control" data-choices name="country_timezone" required>
                            <option value=""> Choose one</option>';
                            foreach(get_timezonetypes() as $key => $tz):
                                echo'<option value="'.$key.'" '.($row['country_timezone'] == $key ? 'selected' : '').'>'.$tz.'</option>';
                            endforeach;
                            echo'
                        </select>
                    </div>
